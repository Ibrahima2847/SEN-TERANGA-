...
<head>
    ...
    <title>SEN TERANGA MARKET</title>
        ...
        <div class="sidebar-wrapper active" style="left:0;">
            <div class="sidebar-header position-relative">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="logo">
                        <a href="../dashboard.php"><img src="../assets/images/logo/logo.png" alt="Logo"
                                srcset="" style= "margin-top: 4px; width: 150px; height: auto;"></a>
                    </div>
            ...
            <div class="sidebar-menu">
                    ...
                    <div class="card-body py-4 px-4">
                        <div class="d-flex align-items-center">
                            <div class="avatar bg-primary me-3">
                                <span
                                    class="avatar-content"></span>
                            </div>
                            <div class="ms-1 name">
                                <h6 class="font-bold"></h6>
                                <h6 class="text-muted mb-0">Sokhna Y. SECK</h6>
                            </div>
                ...
                <ul class="menu">
                    ...
                    <li class="sidebar-item  ">
                        <a href="http://localhost/stock/Presentation/dashboard.php" class='sidebar-link'>
                    ...
                    <!--<li class="sidebar-item  has-sub">
                        ...
                        <ul class="submenu ">
                            <li class="submenu-item ">
                                <a href="http://localhost/stock/Presentation/Client/ajouterClient.php">Ajout</a>
                            </li>
                            <li class="submenu-item ">
                                <a href="http://localhost/stock/Presentation/Client/afficherClients.php">Liste</a>
                            </li>
                        </ul>
                    </li>-->
                    <!--<li class="sidebar-item  has-sub">
                        ...
                        <ul class="submenu ">
                            <li class="submenu-item ">
                                <a
                                    href="http://localhost/stock/Presentation/Fournisseur/ajouterFournisseur.php">Ajout</a>
                            </li>
                            <li class="submenu-item ">
                                <a
                                    href="http://localhost/stock/Presentation/Fournisseur/afficherFournisseurs.php">Liste</a>
                            </li>
                        </ul>
                    </li>-->
                    <li class="sidebar-item  has-sub">
                        ...
                        <ul class="submenu ">
                            <li class="submenu-item ">
                                <a href="http://localhost/stock/Presentation/Produit/ajouterProduit.php">Ajout</a>
                            </li>
                            <li class="submenu-item ">
                                <a href="http://localhost/stock/Presentation/Produit/afficherProduits.php">Liste</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item  has-sub">
                        ...
                        <ul class="submenu ">
                            <li class="submenu-item ">
                                <a href="http://localhost/stock/Presentation/Categorie/ajouterCategorie.php">Ajout</a>
                            </li>
                            <li class="submenu-item ">
                                <a href="http://localhost/stock/Presentation/Categorie/afficherCategories.php">Liste</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item  has-sub">
                        ...
                        <ul class="submenu ">
                            <li class="submenu-item ">
                                <a href="http://localhost/stock/Presentation/caisse/caisse.php">Ajout</a>
                            </li>
                            <li class="submenu-item ">
                                <a href="http://localhost/stock/Presentation/Commande/afficherCommandes.php">Liste</a>
                            </li>
                        </ul>
                    </li>
                    <!--<li class="sidebar-item  has-sub">
                        ...
                        <ul class="submenu ">
                            <li class="submenu-item ">
                                <a href="http://localhost/stock/Presentation/Approvisionnement/caisse.php">Ajout</a>
                            </li>
                            <li class="submenu-item ">
                                <a href="http://localhost/stock/Presentation/Approvisionnement/afficherApprovisionnements.php">Liste</a>
                            </li>
                        </ul>
                    </li>-->
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0"><?=DAO::Income()?> FR CFA</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-content pb-4">
                                ...
                                <div class="card d-flex flex-row align-items-center" style="width: 80%; background-color: var(--bs-body-bg);margin:1rem 1.5rem;border: 1px var(--bs-body-bg) solid;">
                                    ...
                                    <div class="card-body d-flex flex-column" style="padding:0.5rem;">
                                        ...
                                        <p class="card-text text-center libel align-self-end" style="font-size: 0.9rem;"><?=$t->get("p")?> Frcfa</p>    
                                    </div>
                                </div>
                        <?php
                            $i++; }
        ...
        <footer>
            <div class="footer clearfix mb-0 text-muted">
                <div class="float-start">
                    <p>2024 &copy; Ibrahima SECK - SEN TERANGA MARKET</p>
                </div>
            </div>
        </footer>
        </div>
