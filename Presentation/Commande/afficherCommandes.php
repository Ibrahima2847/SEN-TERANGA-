    ...
    <div id="main">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-md table-striped" id="table">
                                        ...
                                        <tbody>
                                            <?php
                                            include_once("C:\wamp64\www\stock\Metier\client.php");
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body" id="<?=$t->get("n")?>">
                                                                    <div class="table-responsive">
                                                                        <table class="table table-md " id="table">
                                                                            ...
                                                                            <tbody>
                                                                                <?php
                                                                            include_once("C:\wamp64\www\stock\Metier\ligneCmd.php");
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" class="btn btn-success"
                                                                       onclick="print(<?=$t->get('n')?>)">Imprimer</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        <script>
            function print(ref){
            var mywindow = window.open(`http://localhost/stock/Presentation/Commande/pdf.php?ref=${ref}`, 'PRINT', 'height=400,width=600');
            mywindow.focus(); 
            mywindow.print();
            }
        </script>