...
<script type="text/javascript">
    ...
    function print2(ref){
            var mywindow = window.open(`http://localhost/stock/Presentation/Approvisionnement/pdf.php?ref=${ref}`, 'PRINT', 'height=400,width=600');
            mywindow.focus(); 
            mywindow.print();
...
function addRow2(r,l,p,q){
  ...
  if(!exist){
    ...
    '<td> <div id="total'+i+'" style="font-size: 0.9rem;">'+p+'</div> </td>'+
...
function total2(id){
  var qnt,iprix;
    ...
    document.getElementById("total"+id).innerHTML=String(prix*qnt)+" Frcfa";
  } 
