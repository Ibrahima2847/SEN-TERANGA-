        ...
        <div class="form-group row text-left mb-0 py-2">
            ...
            <div class="col-sm-8 py-1">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <h5 class="text-right font-weight-bold"><?=LigneAppro::total($commande->get("n"))?> Frcfa</h5>
                </div>
                <table width="100%">
                    <tbody>
                            <tr>
                                <td class="">Prix HT</td>
                                <td class="text-right"><?=LigneAppro::total($commande->get("n"))?> Frcfa</td>
                            </tr>
                            <tr>
                                <td class="">Taxe</td>
                                <td class="text-right">20 Frcfa</td>
                            </tr>
                        </tbody>
                    </table>
                    <h6>-------------------------------</h6>
